package lzuer.net.playground.util.crash;
...
import lzuer.net.playground.util.common.AppUtils;
 ...
 * 
 * https://github.com/D-clock/AndroidUtils/blob/master/src/main/java/com/clock/utils/crash/CrashExceptionHandler.java
 */
public class CrashExceptionHandler implements Thread.UncaughtExceptionHandler {
     ...
     * 配置远程传回log到服务器的设置
     *
     * @param crashExceptionRemoteReport CrashExceptionRemoteReport
     */
    ...
    private void saveCrashInfoToFile(Throwable ex) {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            try {
                ...
                randomAccessFile.writeChars("------------Manufacture: " + AppUtils.getDeviceManufacture() + "------------" + "\n");
                randomAccessFile.writeChars("------------DeviceName: " + AppUtils.getDeviceName() + "------------" + "\n");
                randomAccessFile.writeChars("------------SystemVersion: " + AppUtils.getSystemVersion() + "------------" + "\n");
                randomAccessFile.writeChars("------------DeviceIMEI: " + AppUtils.getDeviceIMEI(mApplicationContext) + "------------" + "\n");
                randomAccessFile.writeChars("------------AppVersion: " + AppUtils.getVersionName(mApplicationContext) + "------------" + "\n");
                randomAccessFile.writeChars("------------Crash Environment Info------------" + "\n");
